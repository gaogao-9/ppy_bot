...
function tester(){
	describe(`BotInfo`,_=>{
		describe(`存在チェック`,_=>{
			...
			["id","messageId","name","iconUrl","disabled","messages","priority","intervalActionList","commandActionList","wordActionList","createSequentialMessageObject","createRandomMessageObject","createMessageObject","_getRandomText"].forEach(name=>{
				it(`prototype.${name}`,()=>{
